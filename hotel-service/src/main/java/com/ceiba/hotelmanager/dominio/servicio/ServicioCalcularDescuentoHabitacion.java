...
public class ServicioCalcularDescuentoHabitacion {
    ...
    private final RepositorioHabitacionImpl repositorioHabitacion;

    public ServicioCalcularDescuentoHabitacion(RepositorioHabitacionImpl repositorioHabitacion){
